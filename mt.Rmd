...
kable(a$medianLifeExp, format = "html")
...
DT <- data.table(mean = c(mean(gapminder$lifeExp), mean(gapminder$pop), mean(gapminder$gdpPercap)),
                 median = c(median(gapminder$lifeExp), median(gapminder$pop), median(gapminder$gdpPercap)),
                 modeof = c(Mode(gapminder$lifeExp), Mode(gapminder$pop), Mode(gapminder$gdpPercap)),
                 max = c(max(gapminder$lifeExp), max(gapminder$pop), max(gapminder$gdpPercap)),
                 min = c(min(gapminder$lifeExp), min(gapminder$pop), min(gapminder$gdpPercap)),
                 unique = c(length(unique(gapminder$lifeExp)), length(unique(gapminder$pop)), length(unique(gapminder$gdpPercap))))

DT

ab <- gapminder %>%
  summarize(missing_pop = sum(is.na(pop)),
            mean_pop = mean(pop),
            median_pop = median(pop),
            missing_le = sum(is.na(lifeExp)),
            mean_le = mean(lifeExp),
            median_le = median(lifeExp),
            missing_gdp = sum(is.na(gdpPercap)),
